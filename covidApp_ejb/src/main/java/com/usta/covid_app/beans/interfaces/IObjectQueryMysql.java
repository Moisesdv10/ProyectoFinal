...
public interface IObjectQueryMysql<T> {
	...
	/**
	 * método encargado de buscar y listar
	 * todos los objetos de la consulta deseada.
	 * @return
	 * @throws Exception
	 */
	...
	/*
	 * Método par realizar cualquier cambio o modificacion
	...
	/**
	 * Elimina un objeto dependiendo el id que se solicite
	 * borrar.
	 * @param id
	 * @throws Exception
	 */
	...
	/**
	 * 
	 * busca por el numero de documento
	 */
